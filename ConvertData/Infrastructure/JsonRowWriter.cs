    ...
    internal sealed class JsonRowWriter : IRowWriter
    {
        public void Write(List<Row> rows, string outputPath)
        {
            ...
            for (int i = 0; i < rows.Count; i++)
            {
                ...
                sb.AppendLine("    \"ProfileBeam\": \"" + JsonEscape(r.Profile) + "\",");
                ...
                sb.AppendLine("    \"Mz\": " + r.Mz.ToString(CultureInfo.InvariantCulture) + ",");
                sb.AppendLine("    \"Mx\": " + r.Mx.ToString(CultureInfo.InvariantCulture) + ",");
                sb.AppendLine("    \"Mw\": " + r.Mw.ToString(CultureInfo.InvariantCulture) + ",");
