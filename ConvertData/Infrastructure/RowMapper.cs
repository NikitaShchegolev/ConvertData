...
internal static class RowMapper
{
        ...
        )
    {
        return new Row
        {
            ...
            H_base = NumericParser.ParseDouble(h_base),
            S_base = NumericParser.ParseDouble(s_base),
            B_base = NumericParser.ParseDouble(b_base),
            T_base = NumericParser.ParseDouble(t_base),
